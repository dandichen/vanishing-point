...
def mxnet_flow(img0, sparse_corner_num, num):
    ...
    # flowstereo(mxnet)
    # flow_path = os.path.join('/mnt/scratch/DandiChen/road/flow/1/flowstereo/value', '{:06d}'.format(num))
    # opencv dense flow
    flow_path = os.path.join('/mnt/scratch/DandiChen/road/flow/6/opencv_dense/value', '{:06d}'.format(num))
    # opencv sparse flow
